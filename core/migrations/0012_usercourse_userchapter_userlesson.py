# Generated by Django 5.1 on 2025-03-01 09:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_lesson', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.lesson', verbose_name='Current lesson')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_completed', models.BooleanField(default=False, verbose_name='Is_completed')),
                ('completion_percentage', models.FloatField(default=0.0, verbose_name='Completion percentage')),
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_course_chapters', to='core.chapter', verbose_name='Chapter')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_chapters', to=settings.AUTH_USER_MODEL, verbose_name='User')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_course_lessons', to='core.lesson', verbose_name='Lesson')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_lessons', to=settings.AUTH_USER_MODEL, verbose_name='User')),
