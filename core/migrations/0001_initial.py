# Generated by Django 5.1 on 2025-03-27 12:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_tests', to='core.test', verbose_name='Test')),
                ...
                ('user_lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_tests', to='core.userlesson', verbose_name='User lesson')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_test_content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_answers', to='core.usertest', verbose_name='Test content')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_completed', models.BooleanField(default=False, verbose_name='Is completed')),
                ('text', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_texts', to='core.text', verbose_name='Text')),
                ...
                ('user_lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_texts', to='core.userlesson', verbose_name='User lesson')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_completed', models.BooleanField(default=False, verbose_name='Is completed')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_video_contents', to=settings.AUTH_USER_MODEL, verbose_name='User')),
                ('user_lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_video_contents', to='core.userlesson', verbose_name='User lesson')),
                ('video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_video_contents', to='core.video', verbose_name='Video')),
            ],
            options={
                'verbose_name': 'User video',
                'verbose_name_plural': 'User video contents',
